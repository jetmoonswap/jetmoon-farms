...
interface IMasterChef {
    ...
    function pendingJetm(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/JetmoonVault.sol

pragma solidity 0.6.12;

contract JetmoonVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingJetm(0, address(this));
